...
public class GamePanel extends Panel implements Runnable{
    ...
    Dimension screen = new Dimension(Width, Height);   //size of the panel
    int Paddle_Width = 25;
    ...
    GamePanel(){
        ...
        //this is action listener that will help in moving the paddle with key press
    ...
    public class AL extends KeyAdapter{
        //if I am pressing a key from keyboard so this method should be called
        @Override
        ...
        //if I am releasing a key from keyboard, this method should be called
        @Override
